...
public class RecordsScreen implements Screen {
    ...
    public void render(float delta) {
        ...
        batch.begin();
        font.draw(batch, "Таблица рекордов", MineSweeperGame.VIRTUAL_WIDTH/2f - 140, MineSweeperGame.VIRTUAL_HEIGHT - 100);
        font.draw(batch, "Лучшее время: --:--:--", MineSweeperGame.VIRTUAL_WIDTH/2f - 140, MineSweeperGame.VIRTUAL_HEIGHT/2f);
        font.draw(batch, "Игр сыграно: 0", MineSweeperGame.VIRTUAL_WIDTH/2f - 100, MineSweeperGame.VIRTUAL_HEIGHT/2f - 50);
